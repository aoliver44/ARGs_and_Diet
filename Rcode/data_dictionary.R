...
data_dictionary <- read_excel(path = "Data_dictionary_raw_for_supplement.xlsx")
...
paper_dictionary <- subset(data_dictionary, data_dictionary$`Variable / Field Name` %in% colnames(abx_cluster_features_no_na))
