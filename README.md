...
- In order to run the R container, run: ```docker run --rm -it -p 8787:8787 -e PASSWORD=yourpasswordhere -v path/to/ARG_scripts:/home/Rcode/ -v path/to/ARG_scripts:/home/data/ amr_r_env``` (or whatever you named the container)
